...
import '../widgets/plot_three_info.dart';
// import 'package:fpg_greenhouse/widgets/temp_humid_widget.dart';

// import '../widgets/plot_one_info.dart';

class PlotThreeInfoScreen extends StatefulWidget {
  const PlotThreeInfoScreen({Key? key}) : super(key: key);

  @override
  State<PlotThreeInfoScreen> createState() => _PlotThreeInfoScreenState();
}

class _PlotThreeInfoScreenState extends State<PlotThreeInfoScreen> {
  @override
      ...
      body: Column(
        children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                showDialog(
                                  ...
                                  builder: (context) {
                                    return AlertDialog(
                                      title: const Text('Edit Threshold',style: TextStyle(color: Color.fromARGB(255, 158, 160, 159)),),
                                      content: Form(
                                        // key: _formKey,
                                        child: Column(
                                      ...
                                      actions: [
                                        ...
                                        TextButton(
                                          child: const Text('Edit',style: TextStyle(color:  Color(0xFF023020)),),
                                          onPressed: () {},
                                        ),
                                      ],
                                    );
          ...
          SizedBox(
              ...
              child: const PlotCardsThreeInfo()),
          SizedBox(
