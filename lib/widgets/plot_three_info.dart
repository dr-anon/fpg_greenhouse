...
class PlotCardsThreeInfo extends StatefulWidget {
  const PlotCardsThreeInfo({Key? key}) : super(key: key);

  @override
  State<PlotCardsThreeInfo> createState() => _PlotCardsThreeInfoState();
}

class _PlotCardsThreeInfoState extends State<PlotCardsThreeInfo> {
