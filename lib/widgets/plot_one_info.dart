...
class PlotCardsOneInfo extends StatefulWidget {
  const PlotCardsOneInfo({Key? key}) : super(key: key);

  @override
  State<PlotCardsOneInfo> createState() => _PlotCardsOneInfoState();
}

class _PlotCardsOneInfoState extends State<PlotCardsOneInfo> {
  ...
  Future<void> getCurrentData() async {
    var endpoint = Uri.parse(
        "https://api.thingspeak.com/channels/2204032/feeds.json?api_key=WFBEVY0QBQQMFWXY&results=2");
            ...
            children: [
              Row(
                ...
                children: const [
                  ...
                  Text("Temperature",
                      style: TextStyle(fontSize: 11, color: Color(0xFF023020))),
                ],
              ),
              Text(
                "${data.temp}°C",
