...
class PlotCardsOne extends StatefulWidget {
  const PlotCardsOne({Key? key}) : super(key: key);

  @override
  State<PlotCardsOne> createState() => _PlotCardsOneState();
}

class _PlotCardsOneState extends State<PlotCardsOne> {
      ...
      GestureDetector(
        onTap: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const PlotOneInfoScreen()));
        },
        child: Container(
